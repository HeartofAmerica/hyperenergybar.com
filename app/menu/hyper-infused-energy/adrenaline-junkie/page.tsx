...
export default function AdrenalineJunkie() {
  return (
    <>
      <Nav/>
      <div className="py-28 sm:pt-40 sm:pb-40 bg-adrenalinejunkie/25">
        <div className="container max-w-screen-lg px-5 sm:px-10">
          <div className="sm:grid grid-cols-2 sm:gap-20 sm:flex sm:items-center">
            <div className="bg-adrenalinejunkie rounded-3xl">
              <Image
                src="/assets/img/adrenaline-junkie-full.png"
                quality={100}
                width={1080}
                height={1140}
            ...
            <div className="block">
              ...
              <p className="text-sm sm:text-xl mb-5 sm:mb-10">
                Like a vacation for your tastebuds, Adrenaline Junkie perfectly balances blue raspberry for a crisp, juicy and nostalgic flavor.
              </p>
            </div>
          </div>
        </div>
      </div>
      <div className="wave-margin text-adrenalinejunkie z-40">
        <Wave />
      </div>
      <div className="-mt-2 bg-adrenalinejunkie py-20 sm:py-40">
      ...
      <div className="relative">
        <Image
          ...
          className="mx-auto"
        />
        <div className="absolute w-full top-0 z-40 text-adrenalinejunkie">
          <WaveBottom />
        </div>
      </div>
      <Footer/>
