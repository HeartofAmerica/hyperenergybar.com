            ...
            <div className="grid md:grid-cols-3 gap-10">
              <div className="col-span-2">
                ...
                <div className="block">
                  ...
                  <a href="https://www.instagram.com/hyperenergybar/" target="_blank" className="inline-block text-ltgreen hover:text-green transition-all duration-300 mr-5">
