...
export default function AnnouncementBar() {
  return (
    <Link href="/specials">
      <div className="w-full bg-neon rounded-2xl pt-2 sm:pt-4 pb-4 lg:pb-6">
        <Swiper
          modules={[Autoplay]}
          spaceBetween={30}
          slidesPerView={1}
        ...
        >
          <SwiperSlide>
            <div className="flex items-center overflow-hidden">
              <div className="mx-4 sm:mx-12 text-green w-8 h-8 mt-1">
              ...
              <div className="mx-4 sm:mx-12 text-pinkpowder w-8 h-8 mt-1">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 216 216" fill="currentColor">
