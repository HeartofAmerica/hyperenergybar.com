...
export default function AnnouncementBar() {
  return (
    <Link href="/specials" className="block w-full bg-neon hover:bg-forrest hover:text-neon rounded-xl sm:rounded-2xl pt-3 sm:pt-4 pb-4 lg:pb-6 transition-all duration-300">
      <Swiper
        modules={[Autoplay]}
        spaceBetween={30}
        slidesPerView={1}
      ...
      >
        <SwiperSlide>
          <div className="flex items-center justify-center overflow-visible">
            <div className="pt-1">
              <div className="mx-ab text-green w-4 sm:w-8 h-4 sm:h-8">
            ...
            <div className="obvi-ab text-center">
              CHECK OUT THE FALL SPECIALS MENU
            </div>
            <div className="pt-1">
              <div className="mx-ab sm:mx-10 text-pinkpowder w-4 sm:w-8 h-4 sm:h-8">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 216 216" fill="currentColor">
            ...
            <div className="pt-1">
              <div className="mx-ab sm:mx-10 text-green w-4 sm:w-8 h-4 sm:h-8 hidden sm:block">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 216 216" fill="currentColor">
                  <path d="M0,108c59.65,0,108-48.35,108-108,0,59.65,48.35,108,108,108-59.65,0-108,48.35-108,108,0-59.65-48.35-108-108-108Z"/>
                </svg>
              </div>
